...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.deleteItem.setGeometry(QtCore.QRect(140, 47, 125, 25))
        self.deleteItem.setObjectName("deleteItem")
        self.addItem = QtWidgets.QPushButton(self.centralwidget)
        self.addItem.setGeometry(QtCore.QRect(10, 47, 125, 25))
        self.addItem.setObjectName("addItem")
        self.clear = QtWidgets.QPushButton(self.centralwidget)
        self.clear.setGeometry(QtCore.QRect(270, 47, 125, 25))
        self.clear.setObjectName("clear")
        self.input = QtWidgets.QLineEdit(self.centralwidget)
        self.input.setGeometry(QtCore.QRect(10, 10, 480, 31))
        self.input.setText("")
        self.input.setObjectName("input")
        self.list = QtWidgets.QListWidget(self.centralwidget)
        self.list.setGeometry(QtCore.QRect(10, 80, 480, 361))
        self.list.setObjectName("list")
        self.save = QtWidgets.QPushButton(self.centralwidget)
        self.save.setGeometry(QtCore.QRect(400, 47, 90, 24))
